...
module.exports = {
  ...
  systemName: 'Quarkus-Vue-Admin',         //系统名称
  copyright: '2021 Whatever-Team 出品',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://whatever-team.github.io/quarkus-vue-admin-docs/', name: '文档'},
    {link: 'https://github.com/whatever-team/quarkus-vue-admin', icon: 'github'},
  ],
}
