        ...
        <div class="fold">
          <a-row >
            <a-col :md="8" :sm="24" >
              ...
              >
                <a-input placeholder="请输入" v-model="queryParam.roleName" allow-clear @keyup.enter.native="loadData"/>
              </a-form-item>
            </a-col>
          </a-row>
        </div>
    ...
    <div>
      ...
      >
        <template slot="enabled" slot-scope="text">
          <a-tag :color="text ? 'blue' : 'pink'" v-text="dictItemAction('enabled', text)"></a-tag>
        </template>
...
<script>
import {list, remove, removeBatch} from '@/services/role'
